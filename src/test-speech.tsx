...
import { Apple, ShoppingBag, Plus, Minus, Trash2, Edit2, Mic, MicOff, Save, Check, Calendar } from 'lucide-react';
...
const TestSpeech: React.FC = () => {
  ...
  if (!browserSupportsSpeechRecognition) {
    return <div className="p-4">您的瀏覽器不支持語音識別。</div>;
  }
  ...
  return (
    <div className="p-4 max-w-md mx-auto">
      <h1 className="text-2xl font-bold mb-4">批量語音輸入</h1>
